...
const translations = {
  pt: {
    ...
    heroDescription:
      "Cada protótipo é uma oportunidade de aprendizado, um passo em direção à inovação. Através da experimentação e do desenvolvimento contínuo, transformamos ideias simples em soluções que podem impactar positivamente a vida das pessoas. Acreditamos que todo grande projeto começa com um pequeno protótipo.",
    ...
    challenge1Desc:
      "Desenvolver um motor elétrico que supere as limitações atuais em eficiência, potência e durabilidade, tornando-se uma alternativa viável para aplicações industriais e de transporte.",
    challenge2Title: "Alternativa ao uso de hélio em dirigíveis",
    challenge2Desc:
      "Criar uma solução inovadora que possa substituir o hélio na flutuação de dirigíveis, considerando custos, segurança e impacto ambiental.",
    ...
    footerCopyright: "©DealeGear - São Paulo - Brasil",
    licence: "Licença",
  ...
  en: {
    ...
    heroDescription:
      "Every prototype is a learning opportunity, a step towards innovation. Through experimentation and continuous development, we transform simple ideas into solutions that can positively impact people's lives. We believe that every great project starts with a small prototype.",
    ctaButton: "Get Started",
    prototypesTitle: "Our Prototypes",
    challengesTitle: "Innovation Challenges",
    challenge1Title: "High-performance electric motor",
    challenge1Desc:
      "Develop an electric motor that overcomes current limitations in efficiency, power, and durability, becoming a viable alternative for industrial and transportation applications.",
    challenge2Title: "Alternative to helium in airships",
    challenge2Desc:
      "Create an innovative solution that can replace helium in airship buoyancy, considering costs, safety, and environmental impact.",
  ...
  es: {
    ...
    heroDescription:
      "Cada prototipo es una oportunidad de aprendizaje, un paso hacia la innovación. A través de la experimentación y el desarrollo continuo, transformamos ideas simples en soluciones que pueden impactar positivamente la vida de las personas. Creemos que todo gran proyecto comienza con un pequeño prototipo.",
    ...
    challenge1Desc:
      "Desarrollar un motor eléctrico que supere las limitaciones actuales en eficiencia, potencia y durabilidad, convirtiéndose en una alternativa viable para aplicaciones industriales y de transporte.",
    challenge2Title: "Alternativa al uso de helio en dirigibles",
    challenge2Desc:
      "Crear una solución innovadora que pueda reemplazar el helio en la flotación de dirigibles, considerando costos, seguridad e impacto ambiental.",
...
function createPrototypeCard(prototype) {
  ...
  const imageUrl =
    prototype.image ||
    `https://picsum.photos/seed/${prototype.name}/400/300.webp`;

  card.innerHTML = `
        <img src="${imageUrl}" alt="${prototype.name}" class="prototype-image" 
             onerror="this.src='https://picsum.photos/seed/${prototype.name}/400/300.webp'">
